...
class demo_navigator_iosPage extends React.Component {
  render() {
        ...
        <View style={styles.group}>
          {this._renderRow(recurseTitle, () => {
            this.props.navigator.push({
              title: demo_navigator_ios.title,
              component: demo_navigator_iosPage,
              ...
              onRightButtonPress: () => {
                ...
                AlertIOS.alert(
                  ...
                  [
                    {
                      text: 'OK',
                      onPress: () => {console.log('Tapped OK');ctx.props.navigator.pop()}
                    },
                  ]
                );
              },
...
class demo_navigator_ios extends React.Component {
  static title = '首页title';
  static description = '首页des';
...
AppRegistry.registerComponent('demo_navigator_ios', () => demo_navigator_ios);